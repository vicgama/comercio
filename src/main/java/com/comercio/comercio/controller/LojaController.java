...
public class LojaController {
	...
	public String listarProdutos(Model model) {
		...
		p2.setDescricao("Com 350W de potência e 4 velocidades, diferentes regulagens para melhor se adequar aos mais variados tipos de receitas.");
		p2.setPreco(250.00);
		...
		p3.setDescricao("Televisor com tela plana let Samsung");
		p3.setPreco(6235.70);
